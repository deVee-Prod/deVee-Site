      ...
      <main className="container mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
        <div className="max-w-2xl mx-auto space-y-16">
          ...
          <section dir="rtl" className="text-right space-y-6">
            ...
            <div className="text-base sm:text-lg text-white/75 leading-relaxed space-y-4">
              <p>
                ...
                אני מפיק מוזיקלי וטכנאי סאונד שחי ונושם יצירה. האולפן שלי נבנה בקפידה כדי להעניק למוזיקה שלכם את הסביבה המקצועית והמדויקת ביותר, במטרה להוציא ממנה את הסאונד המקסימלי.
              </p>
              <p>
          ...
          <section className="space-y-6">
            ...
            <div className="text-base sm:text-lg text-white/75 leading-relaxed space-y-4">
              <p>
                Based in Even Yehuda, Israel, I am a music producer, sound engineer, and the founder of deVee Boutique Label.
              </p>
              <p>
