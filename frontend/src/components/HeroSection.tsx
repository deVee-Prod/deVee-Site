  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full mt-auto mb-auto md:mt-auto md:mb-auto">
        ...
        {/* Scroll indicator */}
        <div className="mt-6 sm:mt-7 md:mt-8 mb-8 sm:mb-10 md:mb-12 pb-0 flex flex-col items-center gap-2 animate-bounce opacity-70">
          ...
          <span className="text-[9px] sm:text-[10px] font-semibold tracking-[0.3em] text-white/60 uppercase">Scroll Down</span>
        </div>
      </div>
    </section>
  );
