  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full mt-auto mb-auto md:mt-auto md:mb-auto">
        ...
        {/* Scroll indicator */}
        <div className="mt-6 sm:mt-7 md:mt-8 mb-8 sm:mb-10 md:mb-12 pb-0 flex flex-col items-center gap-2 opacity-70">
          <div className="w-5 h-8 sm:w-6 sm:h-10 border-2 border-white/30 rounded-full flex items-start justify-center p-1.5 sm:p-2">
            <div 
              className="w-1 h-2 sm:w-1.5 sm:h-3 bg-orange-500 rounded-full" 
              style={{ animation: 'scrollWheel 2s ease infinite' }}
            />
          </div>
